                            ...
                            <table id="demo-foo-filtering" class="table table-hover table-actions-bar toggle-circle m-b-0" data-page-size="10">
                                ...
                                <tbody>
                                    ...
                                    foreach ($instituciones as $key => $institucion) {
                                        ...
                                        echo '
                                        <td>
                                            <a href="'.base_url('instituciones/editar/'.$institucion->in_id).'" class="table-action-btn" data-toggle="tooltip" data-placement="top" title="Editar registro"><i class="md md-edit"></i></a>
                                            <a href="'.base_url('instituciones/eliminar/'.$institucion->in_id).'" class="table-action-btn" data-toggle="tooltip" data-placement="top" title="Eliminar registro"><i class="md md-close"></i></a>
                                        </td>
                                        ';
                                        echo "</tr>";
                                    }
