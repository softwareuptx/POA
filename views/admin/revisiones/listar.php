                                ...
                                <tbody>
                                    ...
                                    if ($subareas != FALSE){
                                        foreach ($subareas as $key => $subarea){
                                            ...
                                            echo '
                                            <td>
                                                <a href="'.base_url('revisiones/objetivos/'.$subarea->sub_id).'" class="table-action-btn" data-toggle="tooltip" data-placement="top" title="Revisar"><i class="fa fa-edit"></i></a>
                                            </td>
                                            ';
                                            echo "</tr>";
                                        }
