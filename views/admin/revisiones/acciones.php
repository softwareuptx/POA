                                ...
                                <tbody>
                                    ...
                                    if ($acciones != FALSE){
                                        foreach ($acciones as $key => $accion){
                                            ...
                                            echo "<td>".$accion->status."</td>";
                                            echo '
                                                <td>
                                                    <a href="'.base_url('revisiones/cuatrimestres/'.$accion->ac_id.'/'.$accion->ob_id.'/'.$subarea).'" class="table-action-btn2" data-toggle="tooltip" data-placement="top" title="Revisar"><i class="fa fa-pencil-square-o"></i></a>
                                                </td>
                                            ';
                                            echo "</tr>";
                                        }
